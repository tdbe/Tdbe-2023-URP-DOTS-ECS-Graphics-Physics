...
namespace Unity.Physics.Authoring
{
    ...
    public abstract class JointBaker<T> : Baker<T> where T : BaseJoint
    {
        ...
        public void CheckWorldIndex(uint expectedWorldIndex, Component component)
        {
            // We need a dependency on this too
            uint otherWorldIndex = GetWorldIndex(component);
            Assertions.Assert.AreEqual(expectedWorldIndex, otherWorldIndex);
        }
